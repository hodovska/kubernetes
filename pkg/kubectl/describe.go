...
type Describer interface {
	Describe(namespace, name string, setting DescriberSetting) (output string, err error)
}
...
func (d *NamespaceDescriber) Describe(namespace, name string, setting DescriberSetting) (string, error) {
...
func (d *LimitRangeDescriber) Describe(namespace, name string, setting DescriberSetting) (string, error) {
...
func (d *ResourceQuotaDescriber) Describe(namespace, name string, setting DescriberSetting) (string, error) {
...
func (d *PodDescriber) Describe(namespace, name string, setting DescriberSetting) (string, error) {
	pod, err := d.Pods(namespace).Get(name)
	if err != nil {
		if setting.ShowEvents {
			eventsInterface := d.Events(namespace)
			selector := eventsInterface.GetFieldSelector(&name, &namespace, nil, nil)
			options := api.ListOptions{FieldSelector: selector}
			events, err2 := eventsInterface.List(options)
			if setting.ShowEvents && err2 == nil && len(events.Items) > 0 {
				return tabbedString(func(out io.Writer) error {
...
func (d *PersistentVolumeDescriber) Describe(namespace, name string, setting DescriberSetting) (string, error) {
...
func (d *PersistentVolumeClaimDescriber) Describe(namespace, name string, setting DescriberSetting) (string, error) {
...
func (d *ReplicationControllerDescriber) Describe(namespace, name string, setting DescriberSetting) (string, error) {
...
func (d *ReplicaSetDescriber) Describe(namespace, name string, setting DescriberSetting) (string, error) {
...
func (d *JobDescriber) Describe(namespace, name string, setting DescriberSetting) (string, error) {
...
func (d *DaemonSetDescriber) Describe(namespace, name string, setting DescriberSetting) (string, error) {
...
func (d *SecretDescriber) Describe(namespace, name string, setting DescriberSetting) (string, error) {
...
func (i *IngressDescriber) Describe(namespace, name string, setting DescriberSetting) (string, error) {
	c := i.Extensions().Ingress(namespace)
	ing, err := c.Get(name)
	if err != nil {
		return "", err
	}
	return i.describeIngress(ing, setting)
}
...
func (i *IngressDescriber) describeIngress(ing *extensions.Ingress, settings DescriberSetting) (string, error) {
	return tabbedString(func(out io.Writer) error {
...
func (d *ServiceDescriber) Describe(namespace, name string, setting DescriberSetting) (string, error) {
...
func (d *EndpointsDescriber) Describe(namespace, name string, setting DescriberSetting) (string, error) {
...
func (d *ServiceAccountDescriber) Describe(namespace, name string, setting DescriberSetting) (string, error) {
...
func (d *NodeDescriber) Describe(namespace, name string, setting DescriberSetting) (string, error) {
	mc := d.Nodes()
...
func (d *HorizontalPodAutoscalerDescriber) Describe(namespace, name string, setting DescriberSetting) (string, error) {
...
func (dd *DeploymentDescriber) Describe(namespace, name string, setting DescriberSetting) (string, error) {
	...
	return tabbedString(func(out io.Writer) error {
		...
		if setting.ShowEvents && err == nil && events != nil {
			DescribeEvents(events, out)
		}
		return nil
	})
...
func (d *ConfigMapDescriber) Describe(namespace, name string, setting DescriberSetting) (string, error) {
